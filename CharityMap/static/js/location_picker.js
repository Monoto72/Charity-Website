...
(function ($) {
    ...
    let initial_with_loc_zoom = 12;

    // Global letiables. Nice.
    ...
    function initMap() {
        ...
        let mapEl = document.getElementsByClassName('js-setloc-map')[0];
